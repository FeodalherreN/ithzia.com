...
<template>
  ...
  <main class="homepage">
            ...
            <div class="col-md-4">
              <div class="cat-item image-zoom-effect">
                <div class="image-holder">
                  <a href="index.html">
                    <img
                      src="./assets/images/cat-item1.jpg"
                      alt="categories"
            ...
            <div class="col-md-4">
              <div class="cat-item image-zoom-effect">
                <div class="image-holder">
                  <a href="index.html">
                    <img
                      src="./assets/images/cat-item2.jpg"
                      alt="categories"
                      class="product-image img-fluid"
                    />
                  </a>
            ...
            <div class="col-md-4">
              <div class="cat-item image-zoom-effect">
                <div class="image-holder">
                  <a href="index.html">
                    <img
                      src="./assets/images/cat-item3.jpg"
                      alt="categories"
                      class="product-image img-fluid"
                    />
                  </a>
        ...
        <div class="row">
          ...
          <div class="collection-item d-flex flex-wrap my-5">
            <div class="col-md-6 column-container">
              <div class="image-holder">
                <img
                  src="./assets/images/single-image-2.jpg"
                  alt="collection"
                  class="product-image img-fluid"
                />
              </div>
            ...
            <div class="col-md-6 column-container bg-white">
              <div class="collection-content p-5 m-0 m-md-5">
                ...
                <p>
                  ...
                  cursus ac faucibus sit libero. Ultricies quam nunc, lorem sit lorem urna, pretium
                  aliquam ut. In vel, quis donec dolor id in. Pulvinar commodo mollis diam sed
          ...
          <div class="video-content open-up" data-aos="zoom-out">
            ...
            <div class="video-player">
              <a class="youtube" href="https://www.youtube.com/embed/t7r-T4KbOjc">
                ...
                <img src="./assets/images/text-pattern.png" alt="pattern" class="text-rotate" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="testimonial-item text-center">
              <blockquote>
                <p>
                  “More than expected crazy soft, flexible and best fitted white simple denim
                  shirt.”
                </p>
          ...
          <div class="swiper-slide">
            <div class="testimonial-item text-center">
              <blockquote>
                <p>
                  “Best fitted white denim shirt more white denim than expected flexible crazy
                  soft.”
                </p>
          ...
          <div class="col-md-4">
            <article class="post-item">
              <div class="post-image">
                <a href="index.html">
                  <img
                    src="./assets/images/post-image2.jpg"
                    alt="image"
                    class="post-grid-image img-fluid"
                  />
                </a>
          ...
          <div class="col-md-4">
            <article class="post-item">
              <div class="post-image">
                <a href="index.html">
                  <img
                    src="./assets/images/post-image3.jpg"
                    alt="image"
                    class="post-grid-image img-fluid"
                  />
                </a>
      ...
      <div class="container">
        <div class="row">
          <div class="logo-content d-flex flex-wrap justify-content-between">
            <img src="./assets/images/logo1.png" alt="logo" class="logo-image img-fluid" />
            <img src="./assets/images/logo2.png" alt="logo" class="logo-image img-fluid" />
            <img src="./assets/images/logo3.png" alt="logo" class="logo-image img-fluid" />
            <img src="./assets/images/logo4.png" alt="logo" class="logo-image img-fluid" />
            <img src="./assets/images/logo5.png" alt="logo" class="logo-image img-fluid" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section
      ...
      style="background: url(./assets/images/pattern-bg.png) no-repeat"
    >
      <div class="container">
        <div class="row justify-content-center">
    ...
    <section class="instagram position-relative">
      <div class="d-flex justify-content-center w-100 position-absolute bottom-0 z-1">
        <a href="https://www.instagram.com/ithziasolis/" class="btn btn-dark px-5"
      ...
      <div class="row g-0">
        <div class="col-6 col-sm-4 col-md-2">
          <div class="insta-item">
            <a href="https://www.instagram.com/ithziasolis/" target="_blank">
              <img
        ...
        <div class="col-6 col-sm-4 col-md-2">
          <div class="insta-item">
            <a href="https://www.instagram.com/ithziasolis/" target="_blank">
              <img
                src="./assets/images/insta-item6.jpg"
                alt="instagram"
                class="insta-image img-fluid"
              />
            </a>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-menu footer-menu-004 border-animation-left">
              ...
              <p>
                ...
                <a href="tel:+46 720 00 00 00" class="item-anchor">+46 720 00 00 00</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 text-end">
              <p>© Copyright 2025 Ithzia. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
